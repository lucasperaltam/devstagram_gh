        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="/crear-cuenta" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input id="name" name="name" type="text" placeholder="Tu nombre" class="border p-3 w-full rounded-lg @error('name') border-red-400 @enderror" value="{{ old('name') }}"/>
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input id="username" name="username" type="text" placeholder="Tu nombre de usuario" class="border p-3 w-full rounded-lg @error('username') border-red-400 @enderror" value="{{ old('username') }}" />
					@error('username')
                        <p class="bg-red-400 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    <!--si se agrega _confirmation al password, laravel implementa la funcionalidad de confirmación de password -->
